...
/* ---------------- AUTH WALL ---------------- */
app.use(requireAuth)                 // <— everything below requires a valid Supabase JWT
app.use(adminUsersRouter)            // uses requireAdmin internally
...
app.listen(port, () => {
  ...
  // ===== smart discovery → connect → accept → auto-enqueue =====
